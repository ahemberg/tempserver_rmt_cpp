...
#ifndef TEMPSERVER_RMT_CPP_COMMANDLINEPARSER_H
#define TEMPSERVER_RMT_CPP_COMMANDLINEPARSER_H
...
public:
    ...
    struct cl_opt {
        bool send_to_server = true, measure_temp = true, save_local = true, print = true, verbose = false;
    };
...
#endif //TEMPSERVER_RMT_CPP_COMMANDLINEPARSER_H
